...
| 文档 | 说明 |
|------|------|
| [快速入门](docs/getting-started.md) | 安装、配置、第一个自定义属性 |
| [属性配置](docs/attributes.md) | 属性定义 YAML 格式详解 |
| [脚本 API](docs/script-api.md) | NovaLang 脚本可用函数一览 |
...
| [配置参考](docs/config.md) | config.yml 完整配置项说明 |
